        ...
        <section className="py-32 overflow-hidden bg-white">
            <div className="mx-auto max-w-6xl px-6 lg:px-8">
                <div className="mx-auto max-w-2xl lg:text-center mb-20">
                    <h2 className="text-base font-semibold leading-7 text-green-600 uppercase tracking-wide">The Power of DrivLynk</h2>
                ...
                <div className="flex flex-col gap-24 lg:gap-32">
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                        ...
                        <div className="order-1 lg:order-2">
                            ...
                            <h3 className="text-3xl font-bold text-slate-900 mb-6">Connect, Post, and Grow</h3>
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                        <div className="order-1">
                            ...
                            <h3 className="text-3xl font-bold text-slate-900 mb-6">Verified Profiles Only</h3>
                            <p className="text-lg text-slate-600 leading-relaxed mb-8">
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                        ...
                        <div className="order-1 lg:order-2">
                            ...
                            <h3 className="text-3xl font-bold text-slate-900 mb-6">Find Exactly What You Need</h3>
                            <p className="text-lg text-slate-600 leading-relaxed mb-8">
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                        <div className="order-1">
                            ...
                            <h3 className="text-3xl font-bold text-slate-900 mb-6">Secure, Direct Messaging</h3>
                            <p className="text-lg text-slate-600 leading-relaxed mb-8">
